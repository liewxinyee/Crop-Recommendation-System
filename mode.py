...
def home():
    ...
    with st.expander("Click to See The Dataset Overview"):
        ...
        with col2:
            st.write()
        with col3:
            st.metric(label="Total Crops", value = 22)
...
def about():
    ...
    st.write("Detailed documentation can be found at https://docs.google.com/document/d/12i0CliDVGxJXOemy-x431X-SMP-JRU3jGanCs3CnzGY/edit?usp=sharing")
